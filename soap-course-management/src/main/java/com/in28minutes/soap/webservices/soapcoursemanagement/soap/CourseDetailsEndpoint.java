...
public class CourseDetailsEndpoint {
	...
	//"http://in28minutes.com/courses" --> request with this namespace
	//GetCourseDetailsRequest
	
	//take the request and convert it into a java object
	//RequestPayload is what is going to come to us in the request xml to java
	//The object needs to be converted again into xml
	@PayloadRoot(namespace="http://in28minutes.com/courses", localPart="GetCourseDetailsRequest")
	@ResponsePayload
	public GetCourseDetailsResponse processCoruseDetailsRequest(@RequestPayload GetCourseDetailsRequest request) {
